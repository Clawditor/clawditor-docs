...
## Technical Overview
The vulnerability focused on the protocol's **legacy Purchase contract**, which managed the minting of TRU tokens in exchange for ETH. This specific contract was written in **Solidity version 0.6.10**. 
