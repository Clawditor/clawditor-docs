...
## Technical Overview
The vulnerability focused on the protocol's **legacy Purchase contract**, responsible for minting TRU tokens in exchange for ETH. This contract was written in **Solidity version 0.6.10**. 
